...
<div className='bg-primaryBg shadow-lg border-t-2 border-[1px] border-border mx-4 md:mx-12 mt-12 p-6 mb-12'>

<div className='pt-10'>
<div>
<div className='bg-secondaryBg border-[1px] border-border px-4 py-1 w-fit ml-8'>
<h2 className='text-[11px] font-[700px] text-secondaryText'>Getting Started</h2>
</div>
<h1 className='text-[25px] font-[600] pt-4'>Creating an Account</h1>
<p className='text-[13px] text-secondaryText pt-2'>Irure aute non cillum commodo magna aliquip 
    est consequat ipsum nulla. Est consequat 
    ipsum nulla.
    </p>
</div>

<div className='text-[13px] pb-8 border-b-[1px] border-border text-secondaryText pt-6 space-y-2'>
...
<div className='mt-8'>
    <p className='text-[14px] leading-7 text-secondaryText font-[400]'>
...
<div className='mt-8'>
    ...
    <p className='text-[14px] leading-7 pt-2 text-secondaryText font-[400]'>
...
<div className='mt-8'>
    ...
    <p className='text-[14px] pt-2 leading-7 text-secondaryText font-[400]'>
...
<div className='bg-secondaryBg mx- px-6 py-6 rounded-md space-y-2'>
<div className='flex place-items-center space-x-2'>
<MdArrowBack />
<p className='text-[11px] text-secondary font-[500]'
>Previous</p>
</div>
<p className='text-[13px] font-[600]'>Creating an Account</p>
</div>

<div className='bg-secondaryBg  flex flex-col items-end   mx- px-6 py-6 rounded-md space-y-2'>
<div className='flex place-items-center space-x-2'>
...
<div className='bg-primaryBg shadow-lg border-t-[1px] pb-24 border-border py-6 px-6 sticky mt-12 mx-8 w-[900px] h-fit max-md:hidden'>
...
<div className=' mt-8 space-y-4'>
          <div className="flex place-items-center space-x-1">
                ...
                <h3 className="opacity-[1] text-[13px] hover:text-secondaryText cursor-pointer font-[500] text-gray-600">Syncing Across Devices</h3>
              </div>
